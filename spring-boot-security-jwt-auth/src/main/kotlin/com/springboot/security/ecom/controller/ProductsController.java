package com.springboot.security.ecom.controller;

import com.springboot.security.ecom.model.Products;
import com.springboot.security.ecom.service.ProductsService;
...
public class ProductsController {
    ...
    @Autowired
    ProductsController(ProductsService productService){
        this.productService = productService;
    }

    @GetMapping(value = "/")
    public String home(HttpServletRequest request){
        return "Hello Secure System: "+request.getSession().getId();
    }
...
//    }
    ...
    public ResponseEntity<String> updateProduct(@PathVariable String id, @RequestPart Products product,
                                                @RequestPart MultipartFile imageFile){
